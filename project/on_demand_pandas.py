...
while True :
  user_input = input("Hi! Would you liek to play Pao Ying Chub game :Y/N?  ")
  if user_input == "N" :
    print("See you again! Goodbye! ")
    break
  else:
    Print("What do you choose among Kon/Gangai/Gradad ?")

while True :
  user_input = input("Hi! Would you like to play Pao Ying Chub game :Y/N?  ")
  if user_input == "N" :
  print("See you again! Goodbye! ")
  break
  else:
...
while True:
    ...
    if user_input == "N":
        ...
        print("What do you choose among Kon/Gangai/Gradad?")
        # Logic for the game would continue here
